...
<p><a href="../Adminindex.php?=User">Back to Admin page</a></p>
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="fEmail" name="fEmail" value="<?php echo $Email?>"<?php if ($isUpdated == 1) echo "readonly";?> placeholder="Admin Name..">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
